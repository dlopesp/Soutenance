...
\begin{frame}{Context}
	...
	\begin{itemize}
		...
		\vspace{0.15cm}
		\item Disk often fails in the clamping zone $\rightarrow$ \textbf{Hard analysis}
		\vspace{0.15cm}
    ...
    \begin{tikzpicture}[remember picture, overlay]
    	\node at (current page.south west) [xshift=10.5cm, yshift=2.5cm] {\includegraphics[width=4cm]{Images/rupture_disk.pdf}}; 
    \end{tikzpicture}
...
\begin{frame}{Geometry effect (under helium)}

\begin{itemize}
	\item Good agreement between experimental and numerical results
	\vspace{0.15cm}
...
\begin{figure}
	\centering
	\includegraphics[width=0.9\textwidth]{Images/disks_helium.pdf} \\
\end{figure}
...
\begin{itemize}
	\item Considers only dislocations as traps 
\end{itemize}
