...
\vspace{3.25cm}
	...
	\begin{tikzpicture}[remember picture, overlay]
    	\node at (current page.south west) [xshift=3cm, yshift=2.25cm] {\includegraphics[width=4.5cm]{Images/tensile_test.pdf}}; 
    \end{tikzpicture}
    
	\begin{tikzpicture}[remember picture, overlay]
    	\node at (current page.south west) [xshift=9cm, yshift=1.8cm] {\includegraphics[width=5.5cm]{Images/fracture_surface_2.pdf}}; 
    \end{tikzpicture}
    
	\begin{tikzpicture}[remember picture, overlay]
    	\node at (current page.south west) [xshift=10.5cm, yshift=4cm] {\includegraphics[width=2.5cm]{Images/CT_mDCT.png}}; 
    \end{tikzpicture}
